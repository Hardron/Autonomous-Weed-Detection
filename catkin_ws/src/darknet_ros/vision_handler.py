...
class VisionHandler():
    ...
    def __init__(self):
        ...
        self.SPRAY_LOCATION_LEEWAY = 0.01#0.05#0.065#0.06
        self.SPRAY_LOCATION_LEEWAY_Y = 0.04#0.05#0.065#0.06
    ...
    def check_for_spray(self):
        ...
        for idx,weed_loc in enumerate(self.queue):
            #print("%d :: sprayx %.4f sprayy %.4f weedx %.4f weedy %.4f") % (idx, sprayx ,sprayy, weed_loc.pose.position.x, weed_loc.pose.position.y)
